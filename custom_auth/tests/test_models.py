...
class TestModels(TestCase):
    ...
    def test_create_user(self):
        ...
        self.assertEqual(UserAccount.objects.get(email="test_user1@example.com"), test_user)

    def test_create_superuser(self):
        test_superuser = UserAccount.objects.create_superuser(**self.credentials)
        self.assertEqual(UserAccount.objects.get(email="test_user1@example.com"), test_superuser)
